<template>
  <vs-dialog overlay-blur width="550px" not-center :model-value="modelValue" @update:model-value="$emit('update:modelValue', $event)">
    <template #header>
    ...
    <div class="con-content">
      <vs-alert color="#FE8599" type="gradient" v-model:hidden-content="techHidden">
        ...
        <vs-avatar-group class="aboutAva" float max="8">
          <vs-tooltip placement="top" v-for="tech in techStack" :key="tech.content">
      ...
      <vs-alert color="#00BCD4" type="gradient" v-model:hidden-content="aboutHidden">
        ...
        <p>项目已经开源：</p>
        <p><a href="https://github.com/Honahec/homepage" target="_blank">https://github.com/Honahec/homepage</a></p>
        <p>原作者：</p>
        <p><a href="https://github.com/QNquenan/homepage-for-vue3" target="_blank">https://github.com/QNquenan/homepage-for-vue3</a></p>
      </vs-alert>
    </div>
    ...
    <template #footer>
      <div class="con-footer">
        ...
        <div class="footerBtn">
          <vs-button color="#fe8599" @click="showVersion" type="border">当前版本</vs-button>
          <vs-button color="#fe8599" @click="$emit('update:modelValue', false)">知道啦</vs-button>
        </div>
      </div>
    </template>
  </vs-dialog>
